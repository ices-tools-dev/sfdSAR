...
1.  Determine the gear width of the VMS record according to:
    1.  Where average gear widths are supplied these are used.
    2.  For VMS records with missing gear widths but that have supplied
    ...
    3.  For VMS records with missing gear widths and missing vessel
