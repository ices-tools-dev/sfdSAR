...
1. Determine the gear width of the VMS record according to:
  ...
  2. For VMS records with missing gear widths but that have supplied average 
...
2. Estimate swept area based on gear type, fishing hours (hours), fishing speed 
  ...
  - Danish seine   : hours / 2.591234 x (width^2) / (4 \pi) 
  - Scottish seine : hours / 1.9125 x  (1.5 x width^2) / (4 \pi)
3. Accumulate across gears for each year to produce annual totals of SA by 
...
outputs and was initially developed by ICES (2015).
